...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/lefthook-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Flefthook-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/lefthook-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
...
- [Ultra-Fast Git Hook Pipeline](#ultra-fast-git-hook-pipeline) — before and after rule comparison
...
Install `@sebastienrousseau/lefthook-config` as a development dependency:
...
`@sebastienrousseau/lefthook-config` solves this with three deliberate engineering choices:
...
When your project already mandates Husky v4 legacy scripts or pre-commit Python frameworks across non-JS polyglot repositories.

...
screenshot_alt: "@sebastienrousseau/lefthook-config architecture and rule enforcement."
footer_note: "@sebastienrousseau/lefthook-config is part of the @sebastienrousseau/config suite. Published under Apache-2.0 OR MIT."
copyright: "© 2026 Sebastien Rousseau. Licensed under Apache-2.0 OR MIT."
translation_key: "home"
title: "@sebastienrousseau/lefthook-config — Shareable Lefthook configuration rules for fast, parallel Git hooks execution."
description: "Shareable Lefthook configuration rules for fast, parallel Git hooks execution."
keywords: "lefthook-config, lefthook, git hooks, pre-commit, pre-push, husky alternative, developer tools, sebastien rousseau, standard"
hero_tag: "v0.0.3"
hero_tagline: "Ultra-fast parallel Git hooks configuration"
headline: "@sebastienrousseau/lefthook-config"
lead: "Shareable Lefthook configuration rules for fast, parallel Git hooks execution."
cta_primary: "Install @sebastienrousseau/lefthook-config"
...
snippet_caption: "Install @sebastienrousseau/lefthook-config"
snippet_code: "npm install --save-dev @sebastienrousseau/lefthook-config"
...
Yes. Every configuration allows local overrides directly within your `lefthook.yml` file or inline settings. Detailed override recipes are documented in the [Usage Guide](usage/).

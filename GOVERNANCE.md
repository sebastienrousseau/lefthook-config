...
This document describes how @sebastienrousseau/lefthook-config is run: who decides what, how
...
@sebastienrousseau/lefthook-config is **maintainer-led**. As of the current release line it has a single
